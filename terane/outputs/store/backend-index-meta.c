 ...
 *
 * callspec: Index.get_meta(txn, id, **flags)
 * parameters:
 ...
 */
PyObject *
terane_Index_get_meta (terane_Index *self, PyObject *args, PyObject *kwds)
{
    terane_Txn *txn = NULL;
    PyObject *id = NULL;
    DBT key, data;
 ...
 *
 * callspec: Index.set_meta(txn, id, value, **flags)
 * parameters:
 ...
 */
PyObject *
terane_Index_set_meta (terane_Index *self, PyObject *args, PyObject *kwds)
{
    terane_Txn *txn = NULL;
    PyObject *id = NULL;
    PyObject *metadata = NULL;
