...
{
    { "get_meta", (PyCFunction) terane_Index_get_meta, METH_VARARGS|METH_KEYWORDS,
        "Get a Index metadata value." },
    { "set_meta", (PyCFunction) terane_Index_set_meta, METH_VARARGS|METH_KEYWORDS,
        "Set a Index metadata value." },
    { "get_field", (PyCFunction) terane_Index_get_field, METH_VARARGS|METH_KEYWORDS,
        "Get a field in the Index." },
    { "set_field", (PyCFunction) terane_Index_set_field, METH_VARARGS|METH_KEYWORDS,
        "Add a field to the Index." },
    { "contains_field", (PyCFunction) terane_Index_contains_field, METH_VARARGS|METH_KEYWORDS,
        "Return True if the field exists in the Index." },
    { "iter_fields", (PyCFunction) terane_Index_iter_fields, METH_VARARGS|METH_KEYWORDS,
    ...
    { "set_segment", (PyCFunction) terane_Index_set_segment, METH_VARARGS|METH_KEYWORDS,
        "Add a new segment." },
    { "iter_segments", (PyCFunction) terane_Index_iter_segments, METH_VARARGS|METH_KEYWORDS,
        "Iterate all segments in the Index." },
    { "delete_segment", (PyCFunction) terane_Index_delete_segment, METH_VARARGS|METH_KEYWORDS,
