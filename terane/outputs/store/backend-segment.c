...
{
    { "get_meta", (PyCFunction) terane_Segment_get_meta, METH_KEYWORDS,
        "Get a Segment metadata value." },
    { "set_meta", (PyCFunction) terane_Segment_set_meta, METH_KEYWORDS,
        "Set a Segment metadata value." },
    { "get_field", (PyCFunction) terane_Segment_get_field, METH_KEYWORDS,
        "Get a field metadata value." },
    { "set_field", (PyCFunction) terane_Segment_set_field, METH_KEYWORDS,
        "Set a field metadata value." },
    { "get_event", (PyCFunction) terane_Segment_get_event, METH_KEYWORDS,
        "Get an event blob by event identifier." },
    { "set_event", (PyCFunction) terane_Segment_set_event, METH_KEYWORDS,
        "Set an event value." },
    { "delete_event", (PyCFunction) terane_Segment_delete_event, METH_KEYWORDS,
        "Delete an event." },
    { "contains_event", (PyCFunction) terane_Segment_contains_event, METH_KEYWORDS,
    ...
    { "iter_events", (PyCFunction) terane_Segment_iter_events, METH_KEYWORDS,
        "Iterates through all event identifers in the segment between the start and end event identifier." },
    { "get_term", (PyCFunction) terane_Segment_get_term, METH_KEYWORDS,
        "Get metadata for a term in the segment." },
    { "set_term", (PyCFunction) terane_Segment_set_term, METH_KEYWORDS,
        "Set metadata for a term in the segment." },
    { "iter_terms", (PyCFunction) terane_Segment_iter_terms, METH_KEYWORDS,
        "Iterates through all terms in the segment." },
    { "get_posting", (PyCFunction) terane_Segment_get_posting, METH_KEYWORDS,
        "Get a posting in the segment inverted index." },
    { "contains_posting", (PyCFunction) terane_Segment_contains_posting, METH_KEYWORDS,
        "Returns True if the segment contains the specified posting." },
    { "set_posting", (PyCFunction) terane_Segment_set_posting, METH_KEYWORDS,
    ...
    { "iter_postings", (PyCFunction) terane_Segment_iter_postings, METH_KEYWORDS,
